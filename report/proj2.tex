...
\section{Registering on the web page}
\section{Buying the file on the web page}
\section{Logging in on the player}
...
\begin{enumerate}
  ...
  \item The server sends the session key it generated to the player, also signalling that the operation was completed successfully.
\end{enumerate}

\section{Downloading the file from the player}


\section{Playing the file on the player}
