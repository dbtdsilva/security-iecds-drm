...
///**=========================================================
// * Module: mqtt.js
// * Wraps the mqttws31 from org.eclipse.paho.mqtt.javascript
// =========================================================*/
//
//function noop() {}
//
//// Wraps the built-in WebSocket into a replaceable provider suitable for dependency injection.
//App.service('$mqtt', function() {
//	var mqtt;
//	this.connect = function(host, port, path, clientId) {
//		mqtt = new new Paho.MQTT.Client(host, port, path, clientId);
//    mqtt.onConnectionLost
//    mqtt.onMessageArrived
//    mqtt.onMessageDelivered
//		mqtt.onopen = this.onopen;
//		mqtt.onmessage = this.onmessage;
//		mqtt.onerror = this.onerror;
//		mqtt.onclose = this.onclose;
//	};
