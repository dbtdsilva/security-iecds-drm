...
echo "#                                                         #"
echo "# Install the root certificate on firefox located at      #"
echo "# ./src/server/certificates/rootCA/Security_P3G1_Root.crt #"
echo "# and the                                                 #"
echo "# libpteidpkcs11.so (usr/local/lib/libpteidpkcs11.so) on  #"
echo "# security device                                         #"
echo "###########################################################"
